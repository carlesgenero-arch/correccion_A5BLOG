...
export const NOTICIAS: INew[] = [
  ...
  {
    titulo: 'TypeScript 5.3 mejora la experiencia del desarrollador',
    imagen: 'https://www.google.com/imgres?q=typescript%20300x200&imgurl=https%3A%2F%2Fwww.itdo.com%2Fblog%2Fcontent%2Fimages%2F2021%2F07%2Fitdo-que-es-type-script.jpg&imgrefurl=https%3A%2F%2Fwww.itdo.com%2Fblog%2Fque-es-typescript-y-por-que-utilizarlo%2F&docid=AW6UqYdkdItnKM&tbnid=aVsM9-sXhsgJcM&vet=12ahUKEwjb8ICe0vSSAxV-KvsDHZc_Dp8QnPAOegQILxAB..i&w=999&h=666&hcb=2&ved=2ahUKEwjb8ICe0vSSAxV-KvsDHZc_Dp8QnPAOegQILxAB',
    texto: 'La nueva versión de TypeScript incluye optimizaciones de tipos y mejor soporte para características modernas de JavaScript.',
    fecha: '2024-12-15'
  }
];
